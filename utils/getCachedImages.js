export const getCachedImage = (image, useThumbnail) => {
  let url = null;
  const checkCache =
    typeof process.env.NEXT_PUBLIC_IMAGE_CACHE_MEDIA_URL === "string";
  const checkThumbnailCache =
    typeof process.env.NEXT_PUBLIC_IMAGE_CACHE_THUMBNAIL_URL === "string";
